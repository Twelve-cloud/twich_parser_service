...
from infrastructure.models.twich.elastic.stream_model import Tag, TwichStream
...
class TwichStreamMapper:
    ...
    def to_domain(self, persistence: TwichStream) -> TwichStreamEntity:
        ...
        return TwichStreamEntity(
            ...
            tags=[tag['tag'] for tag in persistence.tags],
    ...
    def to_persistence(self, domain: TwichStreamEntity) -> TwichStream:
        ...
        return TwichStream(
            ...
            title=domain.title,
            tags=[Tag(tag=tag) for tag in domain.tags] if domain.tags else [],
