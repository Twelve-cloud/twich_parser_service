...
class TwichStreamMetadata:
    ...
    parse_stream_response_description: ClassVar[str] = 'Stream has been parsed.'

    delete_stream_summary: ClassVar[str] = 'Delete twich stream by id.'
    delete_stream_description: ClassVar[str] = 'Delete twich stream by id.'
    delete_stream_response_description: ClassVar[str] = 'Stream has been deleted.'

    delete_stream_by_user_login_summary: ClassVar[str] = 'Delete twich stream by user login.'
    delete_stream_by_user_login_description: ClassVar[str] = 'Delete twich stream by user login.'
    delete_stream_by_user_login_response_description: ClassVar[str] = 'Stream has been deleted.'

    get_stream_summary: ClassVar[str] = 'Return twich stream by id.'
    get_stream_description: ClassVar[str] = 'Return twich stream by id.'
    get_stream_response_description: ClassVar[str] = 'Stream has been returned.'
    ...
    get_stream_by_user_login_response_description: ClassVar[str] = 'Stream has been returned.'
    ...
    get_all_streams_response_description: ClassVar[str] = 'All streams have been returned.'
    ...
    @ReadOnlyClassProperty
    def get_stream(cls) -> dict:
        return {
            'summary': cls.get_stream_summary,
            'description': cls.get_stream_description,
            'response_description': cls.get_stream_response_description,
        }
