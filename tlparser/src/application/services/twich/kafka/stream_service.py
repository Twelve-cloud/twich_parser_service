...
from domain.events.twich.stream_events import TwichStreamCreatedOrUpdatedEvent
...
class TwichStreamKafkaService:
    """
    TwichStreamKafkaService: Class, that contains business logic for twich streams.
    """
    ...
    def __init__(
        ...
        """
        __init__: Do some initialization for TwichStreamKafkaService class.
